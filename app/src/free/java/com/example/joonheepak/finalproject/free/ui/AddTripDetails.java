package com.example.joonheepak.finalproject.free.ui;
...
import com.example.joonheepak.finalproject.ui.MainActivity;
...
/**
 * Created by joonheepak on 2/8/17.
 */
        ...
        doneText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (countryFlagImage == null || editTripName.getText().toString().matches("") || dateStartText == null ||
                    ...
                    Intent backToMain = new Intent(AddTripDetails.this, com.example.joonheepak.finalproject.free.MainActivity.class);
